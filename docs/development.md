...
`src/parser.ts`, `src/config.ts`, and their tests are vendored from [obsidian-tabsdown](https://github.com/grafanaKibana/obsidian-tabsdown). The same machine-readable contract drives style validation.
